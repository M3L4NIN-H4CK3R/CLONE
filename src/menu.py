...
██║░╚═╝░██║███████╗░░░██║░░░██║░░██║{H}██████████████████████
╚═╝░░░░░╚═╝╚══════╝░░░╚═╝░░░╚═╝░░╚═╝
                         Made By {M2} Nigeria {P2}Coder""",title=f"{P2}{waktu()}",style=f"{color_table}"))
...
def menu():
	...
	logo()
	akmj = []
	github = "github.com/M3L4NIN-H4CK3R"
	joined = "24 Maret 2022"
	expired = "24 Maret 2023"
	akmj.append(Panel(f"{P2}Name : {nama} \nID : {uid} \nBirthdate : {ttl}",width=37,title=f"{P2}data account",style=f"{color_table}"))
	akmj.append(Panel(f"{P2}Email : {email} \nJoin : {joined} \nExpired : {expired}",width=37,title=f"{P2}data apikey",style=f"{color_table}"))
